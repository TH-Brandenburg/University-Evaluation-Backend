...
UPDATE `choice` SET `id` = 64,`grade` = 1,`text` = 'Positive textAnswer' WHERE `choice`.`id` = 64;
UPDATE `choice` SET `id` = 65,`grade` = 2,`text` = 'Negative textAnswer' WHERE `choice`.`id` = 65;
UPDATE `choice` SET `id` = 66,`grade` = 2,`text` = 'Neutral textAnswer' WHERE `choice`.`id` = 66;
UPDATE `choice` SET `id` = 67,`grade` = 3,`text` = 'Negative textAnswer' WHERE `choice`.`id` = 67;
UPDATE `choice` SET `id` = 68,`grade` = 2,`text` = 'Slightly positive textAnswer' WHERE `choice`.`id` = 68;
UPDATE `choice` SET `id` = 69,`grade` = 3,`text` = 'Slightly negative textAnswer' WHERE `choice`.`id` = 69;
UPDATE `choice` SET `id` = 70,`grade` = 4,`text` = 'Negative textAnswer' WHERE `choice`.`id` = 70;
UPDATE `choice` SET `id` = 71,`grade` = 3,`text` = 'neutral textAnswer' WHERE `choice`.`id` = 71;
UPDATE `choice` SET `id` = 72,`grade` = 4,`text` = 'Slightly negative textAnswer' WHERE `choice`.`id` = 72;
UPDATE `choice` SET `id` = 73,`grade` = 5,`text` = 'Negative textAnswer' WHERE `choice`.`id` = 73;
UPDATE `choice` SET `id` = 74,`grade` = 1,`text` = 'Very positive textAnswer' WHERE `choice`.`id` = 74;
UPDATE `choice` SET `id` = 75,`grade` = 2,`text` = 'positive textAnswer' WHERE `choice`.`id` = 75;
UPDATE `choice` SET `id` = 76,`grade` = 3,`text` = 'Slightly positive textAnswer' WHERE `choice`.`id` = 76;
UPDATE `choice` SET `id` = 77,`grade` = 6,`text` = 'Very negative textAnswer' WHERE `choice`.`id` = 77;
UPDATE `choice` SET `id` = 78,`grade` = 4,`text` = 'Neutral textAnswer' WHERE `choice`.`id` = 78;
UPDATE `choice` SET `id` = 79,`grade` = 5,`text` = 'Slightly negative textAnswer' WHERE `choice`.`id` = 79;
UPDATE `choice` SET `id` = 80,`grade` = 6,`text` = 'Negative textAnswer' WHERE `choice`.`id` = 80;
UPDATE `choice` SET `id` = 81,`grade` = 7,`text` = 'Very negative textAnswer' WHERE `choice`.`id` = 81;
...
UPDATE `mc_question` SET `id` = 20,`text` = 'Interface for question with 2 + 1 possible textAnswers.' WHERE `mc_question`.`id` = 20;
UPDATE `mc_question` SET `id` = 21,`text` = 'Interface for question with 3 + 1 possible textAnswers.' WHERE `mc_question`.`id` = 21;
UPDATE `mc_question` SET `id` = 22,`text` = 'Interface for question with 3 + 1 possible textAnswers. The best textAnswer placed in the middle.' WHERE `mc_question`.`id` = 22;
UPDATE `mc_question` SET `id` = 23,`text` = 'Interface for question with 4 + 1 possible textAnswers.' WHERE `mc_question`.`id` = 23;
UPDATE `mc_question` SET `id` = 24,`text` = 'Interface for question with 5 + 1 possible textAnswers.' WHERE `mc_question`.`id` = 24;
UPDATE `mc_question` SET `id` = 25,`text` = 'Interface for question with 5 + 1 possible textAnswers. The best textAnswer placed in the middle.' WHERE `mc_question`.`id` = 25;
UPDATE `mc_question` SET `id` = 26,`text` = 'Interface for question with 6 + 1 possible textAnswers.' WHERE `mc_question`.`id` = 26;
UPDATE `mc_question` SET `id` = 28,`text` = 'Interface for question with 6 + 1 possible textAnswers. The best textAnswer placed in the middle.' WHERE `mc_question`.`id` = 28;
UPDATE `mc_question` SET `id` = 27,`text` = 'Interface for question with 7 + 1 possible textAnswers.' WHERE `mc_question`.`id` = 27;
